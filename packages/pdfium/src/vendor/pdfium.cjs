...
var _EPDFAnnot_GetBooleanValue = Module['_EPDFAnnot_GetBooleanValue'] = createExportWrapper('EPDFAnnot_GetBooleanValue', 3);
var _EPDFAnnot_SetBooleanValue = Module['_EPDFAnnot_SetBooleanValue'] = createExportWrapper('EPDFAnnot_SetBooleanValue', 3);
var _EPDFAnnot_GetMeasurementScale = Module['_EPDFAnnot_GetMeasurementScale'] = createExportWrapper('EPDFAnnot_GetMeasurementScale', 6);
var _EPDFAnnot_SetMeasurementScale = Module['_EPDFAnnot_SetMeasurementScale'] = createExportWrapper('EPDFAnnot_SetMeasurementScale', 8);
var _EPDFAnnot_ClearMeasurementScale = Module['_EPDFAnnot_ClearMeasurementScale'] = createExportWrapper('EPDFAnnot_ClearMeasurementScale', 1);
var _EPDFAnnot_GetMeasurementScaleLabel = Module['_EPDFAnnot_GetMeasurementScaleLabel'] = createExportWrapper('EPDFAnnot_GetMeasurementScaleLabel', 3);
var _EPDFAnnot_GetMeasurementDistanceUnit = Module['_EPDFAnnot_GetMeasurementDistanceUnit'] = createExportWrapper('EPDFAnnot_GetMeasurementDistanceUnit', 3);
var _EPDFAnnot_GetMeasurementAreaUnit = Module['_EPDFAnnot_GetMeasurementAreaUnit'] = createExportWrapper('EPDFAnnot_GetMeasurementAreaUnit', 3);
var _EPDFAnnot_GetLineDimension = Module['_EPDFAnnot_GetLineDimension'] = createExportWrapper('EPDFAnnot_GetLineDimension', 7);
var _EPDFAnnot_SetLineDimension = Module['_EPDFAnnot_SetLineDimension'] = createExportWrapper('EPDFAnnot_SetLineDimension', 7);
...
var _EPDFPage_GetMeasurementScale = Module['_EPDFPage_GetMeasurementScale'] = createExportWrapper('EPDFPage_GetMeasurementScale', 6);
var _EPDFPage_SetMeasurementScale = Module['_EPDFPage_SetMeasurementScale'] = createExportWrapper('EPDFPage_SetMeasurementScale', 8);
var _EPDFPage_ClearMeasurementScale = Module['_EPDFPage_ClearMeasurementScale'] = createExportWrapper('EPDFPage_ClearMeasurementScale', 1);
var _EPDFPage_GetMeasurementScaleLabel = Module['_EPDFPage_GetMeasurementScaleLabel'] = createExportWrapper('EPDFPage_GetMeasurementScaleLabel', 3);
var _EPDFPage_GetMeasurementDistanceUnit = Module['_EPDFPage_GetMeasurementDistanceUnit'] = createExportWrapper('EPDFPage_GetMeasurementDistanceUnit', 3);
var _EPDFPage_GetMeasurementAreaUnit = Module['_EPDFPage_GetMeasurementAreaUnit'] = createExportWrapper('EPDFPage_GetMeasurementAreaUnit', 3);

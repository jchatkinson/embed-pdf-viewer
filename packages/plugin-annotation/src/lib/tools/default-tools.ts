...
const lineTools = [
  ...
  {
    id: 'linearMeasure' as const,
    name: 'Linear Measure',
    labelKey: 'annotation.linearMeasure',
    categories: ['annotation', 'shape'],
    matchScore: (a) => (a.type === PdfAnnotationSubtype.LINE && a.intent === 'LineDimension' ? 20 : 0),
    interaction: {
      exclusive: false,
      cursor: 'crosshair',
      isDraggable: true,
    ...
    defaults: {
      ...
      strokeStyle: PdfAnnotationBorderStyle.SOLID,
      lineEndings: {
        start: PdfAnnotationLineEnding.OpenArrow,
        end: PdfAnnotationLineEnding.OpenArrow,
      },
      measurement: {
        measure: {
          scaleLabel: '1 pt = 1 pt',
          distance: {
            unit: 'pt',
            conversionFactor: 1,
            precision: 2,
        ...
        showCaption: true,
        captionPosition: PdfLineMeasurementCaptionPosition.Top,
    ...
    transform: patchLineMeasurement,
    pointerHandler: lineHandlerFactory,
  },
  {
